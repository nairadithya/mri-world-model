...
# %%
# 2D slice-level training (≈20k samples/epoch), reserved-final eval, LUMIERE
# feature encode (SAILOR not mounted).
!python -u scripts/train_supervised_cnn2d.py --config kaggle.yaml --train --eval-final --encode --encode-scope lum --augment --epochs 30 --lr 0.0003 --slice-batch 32 --patience 8 --min-epochs 5 --checkpoint-dir /kaggle/working/cnn2d --ckpt /kaggle/working/cnn2d/best.pt --feature-cache /kaggle/working/cnn2d_features.pt 2>&1 | tee /kaggle/working/train_cnn2d.log
